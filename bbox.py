...
dataset_path = './'
# test_df = pd.read_csv('bbox_train.txt', sep=' ', header=None, names=['filename', 'class'])
# train_df = pd.read_csv('bbox_test.txt', sep=' ', header=None, names=['filename', 'class'])
test_df = pd.read_csv('test/bbox_train.txt', sep=' ', header=None, names=['filename', 'class0', 'class1', 'class2', 'class3'])
train_df = pd.read_csv('test/bbox_test.txt', sep=' ', header=None, names=['filename', 'class0', 'class1', 'class2', 'class3'])
